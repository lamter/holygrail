...
class Winroll(object):
    ...
    def __init__(self, nav):
        ...
        self.df = None  # pd.DataFrame(index=datatime, columns=[optsv1, optsv2, ...])
    ...
    def loadDF(self, period):
        fn = '{}.df_{}.pickle'.format(self.__class__.__name__, period)
